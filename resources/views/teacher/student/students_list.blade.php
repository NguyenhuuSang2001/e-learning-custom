                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button"
                                                    ...
                                                    data-student_id="{{ $student['student']['user_id'] }}" data
                                            ...
                                            <td>
                                                ...
                                                <button type="button"
                                                    ...
                                                    @isset($teacherInfo->signature->file_path)
                        ...
                        <div style="width:800px; height:600px; padding:20px; text-align:center; border: 10px solid #787878">
                            <div style="width:750px; height:550px; padding:20px;  border: 5px solid #787878">
                                ...
                                <div style="text-align: right; padding-right: 20px;">
                                    <img src="" alt="Signature" id="teacherSignature"
                ...
                success: function(data) {
                    if (data != 'false') {
                        ...
                        $.each(data, function(key, index) {
                            ...
                            var result_status =
                                '<span class="label label-default">Not Attended Yet</span>';
                            if (index['submissions'][0]) {
                                result_status = index['submissions'][0].result_status;
                            }
                            if (result_status ==
                                {{ \App\Libraries\Enumerations\ResultStatus::$FAILED }}) {
                                result_status =
                                    '<span class="label label-danger">Failed</span>';
                            } else if (result_status ==
                                {{ \App\Libraries\Enumerations\ResultStatus::$JUDGING }}) {
                                result_status =
                                    '<span class="label label-info">Judgement Pending</span>';
                            } else if (result_status ==
                                {{ \App\Libraries\Enumerations\ResultStatus::$PASSED }}) {
                                result_status =
