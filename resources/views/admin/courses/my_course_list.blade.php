                    ...
                    <div class="x_content">
                        ...
                        @else
                            ...
                            <table style="text-align: center;"
                                class="table table-striped table-bordered dataTable no-footer" id="data">
                                ...
                                <tbody>
                                    @foreach ($teacher_courses as $t_course)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">{{ $t_course->academic_year }}</td>
                                            <td>{{ $t_course->course_short_code }}</td>
                                            <td>{{ $t_course->created_at }}</td>

                                            <td class="text-center">
                                                <a href="{{ route('getLessonsByCourseId', ['course_id' => $t_course->course_id]) }}"
                                                    class="" title="Edit"><button type="button"
                                                        class="btn btn-info btn-sm"><i class="fa fa-pencil-square-o"
                                                            aria-hidden="true"></i></button></a>
                                                <a href="{{ route('my-courses-delete', ['id' => $t_course->id]) }}"
