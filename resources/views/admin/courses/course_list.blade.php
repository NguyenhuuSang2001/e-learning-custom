        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Courses List</h2>
                        <button type="button" class="pull-right btn btn-info btn-sm" data-toggle="modal"
                                            ...
                                            @if (\Illuminate\Support\Facades\Auth::user()->user_type == \App\Libraries\Enumerations\UserTypes::$ADMIN)
                                                <td class="text-center">
                                                    <button type="button" data-id="{{ $course->id }}"
                                                        ...
                                                        data-academic_year="{{ $course->academic_year }}"
                                                        data-short_code="{{ $course->short_code }}"
                                                        data-featured_text="{{ $course->featured_text }}"
                                                        data-status="{{ $course->status }}"
                                                        data-featured_image="{{ $course->featured_image }}" data
                                                    ...
                                                    <a href="{{ route('courses-delete', ['id' => $course->id]) }}"
                                                        class="delete" title="Delete"><button type="button"
                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <select name="academic_year" id="academic_year_id" required class="form-control">
                                            @php
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <select class="form-control" name="status" id="modal_status">
                                            <option value="{{ \App\Libraries\Enumerations\DepartmentStatus::$APPROVED }}">
                                                Approve</option>
                                            <option value="{{ \App\Libraries\Enumerations\DepartmentStatus::$PENDING }}">
                                                Pending</option>
                                            <option value="{{ \App\Libraries\Enumerations\DepartmentStatus::$BANNED }}">
                                                Banned</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <img src="" id="modal_featured_image" alt="..."
                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td colspan="2"><label>Year</label></td>
                                    <td colspan="2">
                                        <select name="academic_year" id="academic_year" required class="form-control">
                                            @php
                                                $academic_years = ['1', '2', '3', '4'];
                                            @endphp
                                            @foreach ($academic_years as $key => $item)
...
@section('page_js')
    <script>
        $('#updateModal').on('show.bs.modal', function(e) {
            ...
            // console.log($(e.relatedTarget).data('academic_year'));
            $('#academic_year_id').val($(e.relatedTarget).data('academic_year'));
