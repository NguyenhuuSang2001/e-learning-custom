                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" method="get"
                            action="{{ route('course-lessons-list') }}">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <select name="course_id" id="course_id" class="select2_single form-control"
                                            tabindex="-1">
                                            <option></option>
                                            @if ($courses)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" data-id="{{ $lesson->id }}"
                                                        ...
                                                        data-title="{{ $lesson->title }}" data class="btn btn-info btn-sm"
                                                        data-toggle="modal" data-target="#updateModal">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>

                                                    <a href="{{ route('lesson-delete', ['course_id' => $course_id, 'id' => $lesson->id]) }}"
                                                        class="delete" title="Delete"><button type="button"
                                                            class="btn btn-danger btn-sm"><i class="fa fa-trash-o"
                                                                aria-hidden="true"></i></button></a>
                                                    <a href="{{ route('getLessonDetails', ['id' => $lesson->id]) }}"
                                                        title="Details"><button type="button"
                    ...
                    <div class="modal-body">
                        <div class="col-md-8">
                            ...
                            <table class="table">
                                ...
                                <input type="hidden" name="course_id" value="<?php if (isset($course_id)) {
                                    echo $course_id;
                                } ?>">
                                <tr>
