...
class StudentController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        DB::transaction(function ($request) {
            ...
            $meta->academic_year = $user->academic_year;
            $meta->save();
    ...
    public function getLoggedStudentCourses()
    {
        ...
        $incompleteCourses = StudentCourse::with(['teacher_course' => function ($q) {
        ...
        $completedCourses = StudentCourse::with(['teacher_course' => function ($q) {
            $q->with(['course', 'teacher' => function ($q) {
                $q->with(['user']);
            }]);
        }])
